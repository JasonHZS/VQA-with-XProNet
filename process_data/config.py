...
class cfg():
    def __init__(self):
        ...
        self.FVQA.test_data_path = '/root/vqa/VQA-with-XProNet/data/new_dataset_release/test_qs_data.json'
        self.FVQA.train_data_path = '/root/vqa/VQA-with-XProNet/data/new_dataset_release/train_qs_data.json'
